...
async def database_health() -> dict[str, Any]:
    ...
    """
    from reclaim.infrastructure.database import get_pool_stats
...
async def debug_stats() -> dict[str, Any]:
    ...
    from reclaim.infrastructure.database import get_db_connection, get_pool_stats
    from reclaim.infrastructure.llm_budget import get_daily_usage_report
