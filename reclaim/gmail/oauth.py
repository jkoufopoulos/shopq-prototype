...
from reclaim.storage.user_credentials_repository import UserCredentialsRepository
...
class GmailOAuthService:
    ...
    def store_user_credentials(
        ...
        Side Effects:
            - Writes encrypted tokens to user_credentials table in reclaim.db
    ...
    def refresh_credentials(
        ...
        Side Effects:
            ...
            - Writes updated encrypted tokens to user_credentials table in reclaim.db
