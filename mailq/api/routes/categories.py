"""Categories management endpoints for MailQ API.
...
from mailq.api.models import CategoryCreate
...
async def get_categories() -> list[dict[str, Any]]:
    ...
    Side Effects:
        - Reads from categories table in mailq.db
...
async def create_category(
    ...
    Side Effects:
        - Writes to categories table in mailq.db via category_manager.add_category()
