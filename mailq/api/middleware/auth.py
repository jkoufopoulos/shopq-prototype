"""Authentication middleware for MailQ API"""
...
class APIKeyAuth:
    ...
    API key should be set in MAILQ_ADMIN_API_KEY environment variable.
    ...
    def __init__(self):
        ...
        if not self.api_key:
            ...
            logging.warning("MAILQ_ADMIN_API_KEY not set - admin endpoints are unprotected!")
