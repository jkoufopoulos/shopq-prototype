...
NOISE_ELEVATION_LLM_ENABLED = os.getenv("MAILQ_NOISE_ELEVATION_LLM", "false").lower() == "true"

# Maximum emails to review with Editor LLM (cost control)
NOISE_ELEVATION_MAX_EMAILS = int(os.getenv("MAILQ_NOISE_ELEVATION_MAX_EMAILS", "30"))

# Maximum elevations per digest (prevent over-elevation)
NOISE_ELEVATION_MAX_ELEVATIONS = int(os.getenv("MAILQ_NOISE_ELEVATION_MAX", "3"))

# Minimum confidence for LLM elevation
NOISE_ELEVATION_CONFIDENCE_THRESHOLD = float(os.getenv("MAILQ_NOISE_ELEVATION_CONFIDENCE", "0.85"))
...
HIGH_VALUE_THRESHOLD_USD = float(os.getenv("MAILQ_HIGH_VALUE_THRESHOLD", "500"))
...
class NoiseElevationStage:
    ...
    def process(self, context: Any) -> Any:
        ...
        """
        from mailq.digest.digest_pipeline import StageResult
        ...
        if NOISE_ELEVATION_LLM_ENABLED and remaining_noise:
            ...
            logger.debug("Phase 2 disabled (MAILQ_NOISE_ELEVATION_LLM=false)")
