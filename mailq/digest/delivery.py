...
class DigestDelivery:
    ...
    def __init__(
        ...
        - SMTP_FROM_NAME: From name (default: "MailQ")
        """
    ...
    def send_test_email(self, to_email: str) -> bool:
        ...
        <html>
        <body>
            <h2>MailQ Test Email</h2>
            <p>This is a test email from MailQ Digest.</p>
...
def test_smtp_config(to_email: str) -> None:
    ...
    Usage:
        from mailq.digest.delivery import test_smtp_config
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        logger.info("Usage: python -m mailq.digest_delivery <email>")
        logger.info("Example: python -m mailq.digest_delivery user@example.com")
        sys.exit(1)
