...
# Set MAILQ_CLASSIFIER_PROMPT to use alternate prompt (e.g., "classifier_prompt_simplified")
CLASSIFIER_PROMPT_NAME = os.getenv("MAILQ_CLASSIFIER_PROMPT", "classifier_prompt")
