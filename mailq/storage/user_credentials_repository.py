...
- Encryption key must be set via MAILQ_ENCRYPTION_KEY environment variable
...
class UserCredentialsRepository(BaseRepository):
    ...
    def _get_cipher(self) -> Fernet:
        ...
        Raises:
            ValueError: If MAILQ_ENCRYPTION_KEY is not set
        """
        encryption_key = os.getenv("MAILQ_ENCRYPTION_KEY")
    ...
    def store_credentials(
        ...
        Side Effects:
            - Inserts or updates row in user_credentials table in mailq.db
