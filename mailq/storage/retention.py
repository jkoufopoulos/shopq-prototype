...
Implements 14-day retention policy and anonymization for MailQ artifacts.
...
Usage:
    ...
    python -m mailq.retention cleanup --days 14

    # Anonymize data for non-owner access
    from mailq.shared.retention import anonymize_email_thread
...
from mailq.storage.cloud import DIGESTS_PREFIX, SESSIONS_PREFIX, StorageClient
...
def cleanup_old_artifacts(
    ...
    Side Effects:
    - Deletes from `email_threads` table in mailq.db
    - Deletes from `digest_sessions` table in mailq.db
