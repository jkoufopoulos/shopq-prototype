...
This adapter bridges the existing FastAPI (mailq/api.py) with the refactored
...
from mailq.classification.mapper import compute_client_label
...
def api_email_to_parsed(api_email: Any, email_id: str | None = None) -> ParsedEmail:
    ...
    base = RawEmail(
        ...
        to_address="api@mailq.com",  # Placeholder for API emails
