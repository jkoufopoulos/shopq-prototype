...
Usage:
    from mailq.concepts.preferences import UserPreferenceManager
...
class UserPreferenceManager:
    ...
    def _ensure_table_exists(self):
        ...
        Side Effects:
            - Creates user_preferences table in mailq.db if not exists
    ...
    def add_preference(
        ...
        Side Effects:
            - Inserts or updates user_preferences table in mailq.db
            - Writes to database via db_transaction()
    ...
    def remove_preference(self, thread_id: str) -> bool:
        ...
        Side Effects:
            - Deletes row from user_preferences table in mailq.db
            - Writes to database via db_transaction()
    ...
    def cleanup_expired(self) -> int:
        ...
        Side Effects:
            - Deletes expired rows from user_preferences table in mailq.db
            - Writes to database via db_transaction()
