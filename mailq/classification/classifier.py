...
class EmailClassifier:
    ...
    Example:
        ...
        >>> result.gmail_labels  # ['MailQ-Everything-Else']
    """
    ...
    def classify_and_learn(
        ...
        if result.decider == "gemini" and result.confidence >= LEARNING_MIN_CONFIDENCE:
            try:
                ...
                primary_label = labels[0] if labels else "MailQ-Everything-Else"
    ...
    def learn_from_correction(
        ...
        Args:
            ...
            user_id: User ID for personalized rules
        """
        from mailq.observability.confidence import USER_CORRECTION_CONFIDENCE
    ...
    def _rule_category_to_type(self, category: str) -> str:
        ...
        # Strip MailQ- prefix if present
        category_clean = category.replace("MailQ-", "").replace("MailQ/", "").lower()
