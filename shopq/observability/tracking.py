...
Key: EmailThreadTracker stores all decisions in central shopq.db for telemetry.
"""
...
class EmailThreadTracker:
    ...
    NOTE: Uses central database (shopq/data/shopq.db) for all tracking data.
    Old database (data/shopq_tracking.db) is deprecated.
    """
    ...
    def __init__(self, db_path: str | None = None):
        ...
        if db_path is not None:
            logger.warning(
                ...
                "Using central database (shopq/data/shopq.db) instead."
            )
    ...
    def _init_db(self) -> None:
        """
        Initialize tracking database (uses central shopq.db)
        ...
        Side Effects:
            ...
            - Writes schema changes to shopq.db via db_transaction
        """
    ...
    def track_classification(
        ...
        Side Effects:
            - Writes to `email_threads` table in shopq.db (INSERT OR REPLACE)
    ...
    def get_session_summary(self, session_id: str) -> dict[str, Any]:
        ...
        Side Effects:
            ...
            - Performs SELECT queries on shopq.db
        """
    ...
    def print_session_report(self, session_id: str) -> None:
        ...
        from shopq.observability.tracking_reports import print_session_report
    ...
    def export_csv(self, session_id: str, output_path: str) -> None:
        ...
        from shopq.observability.tracking_reports import export_csv
    ...
    def sync_to_gcs(self, session_id: str, digest_html: str | None = None) -> bool:
        ...
        from shopq.observability.tracking_reports import sync_to_gcs
