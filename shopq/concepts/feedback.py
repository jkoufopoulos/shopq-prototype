...
class FeedbackManager:
    ...
    All data stored in shopq.db using connection pooling for performance.
    """
    ...
    def record_correction(
        ...
        Side Effects:
        - Writes to `corrections` table in shopq.db
    ...
    def _extract_type_from_labels(self, labels: list[str]) -> str | None:
        """Extract type from labels like ['ShopQ/Receipts', 'ShopQ/Finance']"""
        # Map label names back to types
        type_map = {
            "ShopQ/Newsletters": "newsletter",
            "ShopQ/Notifications": "notification",
            "ShopQ/Receipts": "receipt",
            "ShopQ/Events": "event",
            "ShopQ/Promotions": "promotion",
            "ShopQ/Messages": "message",
            "ShopQ/Review-Later": "uncategorized",
            "ShopQ/Uncategorized": "uncategorized",
        }
        for label in labels:
    ...
    def _extract_domains_from_labels(self, labels: list[str]) -> list[str]:
        """Extract domains from labels like ['ShopQ/Finance', 'ShopQ/Work']"""
        # Map label names back to domains
        domain_map = {
            "ShopQ/Finance": "finance",
            "ShopQ/Shopping": "shopping",
            "ShopQ/Work": "professional",
            "ShopQ/Personal": "personal",
        }
        domains = []
        for label in labels:
