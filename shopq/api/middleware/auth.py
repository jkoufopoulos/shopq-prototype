"""Authentication middleware for ShopQ API"""
...
class APIKeyAuth:
    ...
    API key should be set in SHOPQ_ADMIN_API_KEY environment variable.
    ...
    def __init__(self):
        ...
        if not self.api_key:
            ...
            logging.warning("SHOPQ_ADMIN_API_KEY not set - admin endpoints are unprotected!")
