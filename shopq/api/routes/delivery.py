...
from shopq.delivery.carrier_locations import get_all_locations, get_nearby_locations
from shopq.delivery.models import (
    Address,
    CarrierLocation,
    ConfirmRequest,
    DeliveryResponse,
...
from shopq.delivery.service import (
...
async def uber_webhook(request: Request) -> dict:
    ...
    from shopq.delivery.models import DeliveryStatus
    from shopq.delivery.repository import DeliveryRepository
