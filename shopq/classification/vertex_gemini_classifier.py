...
from shopq.llm.prompts import get_classifier_prompt
from shopq.llm.prompts.classifier_examples import STATIC_FEWSHOT_EXAMPLES
...
from shopq.utils.versioning import MODEL_NAME, MODEL_VERSION, PROMPT_VERSION
...
try:
    from shopq.observability.structured import EventType
    from shopq.observability.structured import get_logger as get_structured_logger
...
class VertexGeminiClassifier:
    ...
    def _build_fewshot_examples(self) -> str:
        ...
        Side Effects:
            - Reads from learned_patterns table in shopq.db (via feedback_manager)
        """
