...
- ShopQ-Receipts: Purchase confirmations, order updates
- ShopQ-Messages: Personal/professional correspondence
- ShopQ-Action-Required: Critical items needing immediate attention
- ShopQ-Everything-Else: Newsletters, notifications, promotions, etc.

NOTE: Granular type/domain labels (ShopQ-Notifications, ShopQ-Finance, etc.)
...
def map_to_gmail_labels(
    ...
    **_kwargs: Any,  # Ignore legacy gate parameters
    ...
    gmail_label = CLIENT_LABEL_TO_GMAIL.get(client_label, "ShopQ-Everything-Else")
