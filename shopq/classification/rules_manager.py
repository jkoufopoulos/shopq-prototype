...
Manages rules stored in central shopq.db, supporting user corrections that create
...
def add_rule(
    ...
    Side Effects:
    - Writes to `rules` table in shopq.db
...
def update_rule(rule_id: int, **kwargs: Any) -> bool:
    ...
    Side Effects:
    - Writes to `rules` table in shopq.db (updates specified fields)
...
def delete_rule(rule_id: int) -> bool:
    ...
    Side Effects:
    - Deletes from `rules` table in shopq.db
