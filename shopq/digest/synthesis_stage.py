...
from shopq.digest.llm_synthesis import (
    USE_RAW_DIGEST,
...
<div class="footer">
    {type_counts_html}
    <div class="footer-brand">ShopQ · <a href="#">Settings</a></div>
</div>
</body>
</html>"""
...
class SynthesisAndRenderingStage:
    ...
    def process(self, context: DigestContext) -> StageResult:
        ...
        # Enable via: request param raw_digest=true OR env var SHOPQ_RAW_DIGEST=true
