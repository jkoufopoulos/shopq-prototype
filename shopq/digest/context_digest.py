...
class ContextDigest:
    ...
    def _store_debug_data(
        ...
        try:
            from shopq.api.routes.debug import set_last_digest
            ...
            if len(routine) > 0:
                ...
                if noise_breakdown:
                    ...
                    for category, count in sorted_items:
                        ...
                        gmail_link = GmailLinkBuilder.search_link("label:ShopQ/Everything-Else")
                        a_style = "color: #1a73e8; text-decoration: none;"
                        lines.append(
    ...
    def generate_v2(
        ...
        from shopq.digest.noise_elevation import NoiseElevationStage
